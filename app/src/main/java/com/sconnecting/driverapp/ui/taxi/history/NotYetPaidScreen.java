...
public class NotYetPaidScreen extends AppCompatActivity {
    ...
    public NotYetPaidTable mNotYetPaidTable;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.taxi_history_notyetpaid);
    ...
    public void initControls(final Completion listener) {
        ...
        mNotYetPaidTable = new NotYetPaidTable((RecyclerView) findViewById(R.id.notyetpaidTable),(SwipeRefreshLayout) findViewById(R.id.refreshControl));

        mNotYetPaidTable.refreshDataList(listener);
    }
