...
public class OnTheWayScreen extends AppCompatActivity {
    ...
    public OnTheWayTable mOnTheWayTable;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.taxi_history_ontheway);
    ...
    public void initControls(final Completion listener) {
        ...
        mOnTheWayTable = new OnTheWayTable((RecyclerView) findViewById(R.id.onthewayTable),(SwipeRefreshLayout) findViewById(R.id.refreshControl));

        mOnTheWayTable.refreshDataList(listener);
    }
