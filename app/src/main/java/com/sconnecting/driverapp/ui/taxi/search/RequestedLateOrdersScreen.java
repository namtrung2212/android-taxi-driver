...
public class RequestedLateOrdersScreen extends AppCompatActivity {
    ...
    public RequestedLateOrdersTable mRequestedLateOrdersTable;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.taxi_late_requestedlateorder);
    ...
    public void initControls(final Completion listener) {
        ...
        mRequestedLateOrdersTable = new RequestedLateOrdersTable((RecyclerView) findViewById(R.id.table), (SwipeRefreshLayout) findViewById(R.id.refreshControl));

        mRequestedLateOrdersTable.refreshDataList(listener);
    }
}
