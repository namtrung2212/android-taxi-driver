...
public class OnTheWayTable extends RecyclerView.Adapter<TravelHistoryCell> {
    ...
    public OnTheWayTable(RecyclerView table, SwipeRefreshLayout refreshCtrl){
    ...
    public void onBindViewHolder(TravelHistoryCell cell, int i) {
        ...
        cell.bind(item, new TravelHistoryCell.OnItemClickListener() {
            ...
            public void onItemClick(final TravelOrder order) {
                ...
                if(((OnTheWayScreen)tableView.getContext()).Caller.equals("OrderScreen") && SCONNECTING.orderScreen != null){

                    ((OnTheWayScreen)tableView.getContext()).onBackPressed();
                    ((OnTheWayScreen)tableView.getContext()).overridePendingTransition(R.anim.pull_in_right, R.anim.push_out_left);
    ...
    public void loadData(final Completion listener){
        ...
        TravelOrderController.GetOnTheWayOrderByDriver(SCONNECTING.driverManager.CurrentDriver.id, new GetItemsListener() {
            @Override
