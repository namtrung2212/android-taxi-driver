...
public class NotYetPaidTable extends RecyclerView.Adapter<TravelHistoryCell> {
    ...
    public NotYetPaidTable(RecyclerView table, SwipeRefreshLayout refreshCtrl){
    ...
    public void onBindViewHolder(TravelHistoryCell cell, int i) {
        ...
        cell.bind(item, new TravelHistoryCell.OnItemClickListener() {
            ...
            public void onItemClick(final TravelOrder order) {
                ...
                if(((NotYetPaidScreen)tableView.getContext()).Caller.equals("OrderScreen") && SCONNECTING.orderScreen != null){

                    ((NotYetPaidScreen)tableView.getContext()).onBackPressed();
                    ((NotYetPaidScreen)tableView.getContext()).overridePendingTransition(R.anim.pull_in_right, R.anim.push_out_left);
    ...
    public void loadData(final Completion listener){
        ...
        TravelOrderController.GetNotYetPaidOrderByDriver(SCONNECTING.driverManager.CurrentDriver.id, new GetItemsListener() {
            @Override
