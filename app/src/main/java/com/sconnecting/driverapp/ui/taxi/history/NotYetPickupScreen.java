...
public class NotYetPickupScreen extends AppCompatActivity {
    ...
    public NotYetPickupTable mNotYetPickupTable;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.taxi_history_notyetpickup);
    ...
    public void initControls(final Completion listener) {
        ...
        mNotYetPickupTable = new NotYetPickupTable((RecyclerView) findViewById(R.id.notyetpickupTable),(SwipeRefreshLayout) findViewById(R.id.refreshControl));

        mNotYetPickupTable.refreshDataList(listener);
    }
